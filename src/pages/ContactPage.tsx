          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <textarea
                id="details"
                rows={5}
                placeholder="Tell me about the space, current challenges, and what you need help with."
                className="w-full rounded-2xl border border-white/10 bg-neutral-950 px-4 py-3 text-white placeholder:text-neutral-500 focus:border-cyan-400/40 focus:outline-none"
              />
            </div>
            <button
              type="button"
              className="w-full rounded-2xl bg-white px-6 py-3 text-sm font-semibold text-neutral-950 transition hover:opacity-90"
            >
              Send Inquiry
            </button>
          </form>
