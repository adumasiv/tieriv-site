      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
          ...
          <div className="flex h-full min-h-[340px] flex-col justify-between rounded-[1.5rem] border border-white/10 bg-neutral-950 p-8">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold">
                A technical partner focused on systems that hold up in the real
                world.
              </h2>
            </div>
        ...
        <div className="flex flex-col justify-center">
          <SectionHeading
            ...
            description="Tier IV is built for organizations that need more than a generic installer. Use this page to highlight your background, the systems you have supported, and the type of clients you serve best."
          />
          <p className="mt-6 text-lg leading-8 text-neutral-300">
            Whether the project involves meeting room upgrades, event space
            workflows, hybrid presentation systems, or troubleshooting aging
            infrastructure, the focus stays the same: build around reliability,
