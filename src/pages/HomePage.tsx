    ...
    <>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8 lg:py-28">
          ...
          >
            ...
            <h1 className="max-w-2xl text-4xl font-semibold leading-tight text-white md:text-6xl">
              AV systems design, integration, and consulting that works when it
              matters.
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-8 text-neutral-300">
              Tier IV helps organizations plan, improve, and support audio
              visual systems for meeting rooms, event spaces, churches, and
            ...
            <div className="mt-10 grid max-w-xl grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={item}
                  className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4 text-sm text-neutral-200 shadow-2xl shadow-black/20"
                >
                  {item}
                </div>
              ))}
                ...
                <div className="mb-6 flex items-center justify-between">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-semibold">
                      Signal path designed for reliability
                    </h2>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      {[
                        ...
                        <div
                          key={input}
                          className="rounded-xl border border-white/10 bg-neutral-900 px-4 py-3 text-sm text-neutral-200"
                        >
                          {input}
                        </div>
                      ))}
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      {[
                        ...
                        <div
                          key={output}
                          className="rounded-xl border border-cyan-400/20 bg-cyan-400/5 px-4 py-3 text-sm text-cyan-100"
                        >
                          {output}
                        </div>
                      ))}
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
            {industries.map((industry) => (
              <div
                key={industry}
                className="rounded-full border border-white/10 bg-neutral-900 px-4 py-2 text-sm text-neutral-300"
              >
                {industry}
              </div>
            ))}
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <SectionHeading
          ...
          description="From new projects to troubled systems, Tier IV delivers practical AV guidance with a focus on reliability, maintainability, and user experience."
        />
      ...
      <section className="bg-white/[0.02] py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <SectionHeading
            ...
            title="Case studies that show how Tier IV approaches problems."
